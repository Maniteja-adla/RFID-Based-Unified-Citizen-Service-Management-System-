...
void check_eeprom_init(void)
{
	...
	if(1)
    {
        ...
        // Initialize User 1 (MANITEJA): Balance = 10000, Vote = 0, Login PIN = "1406", ATM PIN = "1406"
        ByteWrite_25LC512(0x0010, (18000 >> 8) & 0xFF); delay_ms(5);
        ByteWrite_25LC512(0x0011, 18000 & 0xFF); delay_ms(5);
        ByteWrite_25LC512(0x0020, 0x00); delay_ms(5);
        ByteWrite_25LC512(0x0030, '1'); delay_ms(5);
        ByteWrite_25LC512(0x0031, '4'); delay_ms(5);
        ByteWrite_25LC512(0x0032, '0'); delay_ms(5);
        ByteWrite_25LC512(0x0033, '6'); delay_ms(5);
        ByteWrite_25LC512(0x0040, '1'); delay_ms(5);
        ByteWrite_25LC512(0x0041, '4'); delay_ms(5);
        ByteWrite_25LC512(0x0042, '0'); delay_ms(5);
        ByteWrite_25LC512(0x0043, '6'); delay_ms(5);
        
        // Initialize User 2 (GURU): Balance = 5000, Vote = 2, Login PIN = "2222", ATM PIN = "2222"
        ByteWrite_25LC512(0x0012, (5000 >> 8) & 0xFF); delay_ms(5);
        ByteWrite_25LC512(0x0013, 5000 & 0xFF); delay_ms(5);
        ByteWrite_25LC512(0x0021, 0x02); delay_ms(5);
        ByteWrite_25LC512(0x0034, '2'); delay_ms(5);
        ByteWrite_25LC512(0x0035, '2'); delay_ms(5);
        ByteWrite_25LC512(0x0036, '2'); delay_ms(5);
        ByteWrite_25LC512(0x0037, '2'); delay_ms(5);
        ByteWrite_25LC512(0x0044, '2'); delay_ms(5);
        ByteWrite_25LC512(0x0045, '2'); delay_ms(5);
        ByteWrite_25LC512(0x0046, '2'); delay_ms(5);
        ByteWrite_25LC512(0x0047, '2'); delay_ms(5);
        
        // Initialize User 3 (RAKESH): Balance = 2000, Vote = 0, Login PIN = "3333", ATM PIN = "3333"
        ByteWrite_25LC512(0x0014, (2000 >> 8) & 0xFF); delay_ms(5);
        ByteWrite_25LC512(0x0015, 2000 & 0xFF); delay_ms(5);
        ByteWrite_25LC512(0x0022, 0x00); delay_ms(5);
        ByteWrite_25LC512(0x0038, '3'); delay_ms(5);
        ByteWrite_25LC512(0x0039, '3'); delay_ms(5);
        ByteWrite_25LC512(0x003A, '3'); delay_ms(5);
        ByteWrite_25LC512(0x003B, '3'); delay_ms(5);
        ByteWrite_25LC512(0x0048, '3'); delay_ms(5);
        ByteWrite_25LC512(0x0049, '3'); delay_ms(5);
        ByteWrite_25LC512(0x004A, '3'); delay_ms(5);
        ByteWrite_25LC512(0x004B, '3'); delay_ms(5);
    }
}
 ...
 *         Only triggers when outside citizen sessions. Sets flag to process in loop context.
 */
